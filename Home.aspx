 <%@ Page Title="" Language="C#" MasterPageFile="~/ClioentMasterPage.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Default2" %>
						...
						<asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
							        ...
							        <div class="single-new-arrival">
                                       ...
                                       <img src="uploads/<%# Eval("image") %>" alt="new-arrivals images">
									    <%--<img src="assets/images/collection/arrivals1.png" alt="new-arrivals images">--%>
